...
from basic_english.src.presentation.controllers.word_finder_all_controller import WordFinderAllController

def word_finder_all_composer():
    repository = WordsRepository()
    use_case = WordFinder(repository)
    controller = WordFinderAllController(use_case)
